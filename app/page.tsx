...
const IpAddressTrackerPage = () => {
  ...
  const { data: initialGeoLocationData, isLoading } = useQuery('geolocation', `https://geo.ipify.org/api/v2/country,city?apiKey=${process.env.NEXT_PUBLIC_GEOLOCATION_TOKEN}`);
  const {
    ip,
    isp: ispData = '',
